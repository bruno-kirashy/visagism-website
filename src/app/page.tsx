      ...
      <section className="w-full h-screen flex flex-col items-center justify-center overflow-x-auto">
        <div className="w-full h-full flex justify-center items-center flex-col relative overflow-x-hidden">
          ...
          <p className="lg:w-5xl md:w-3xl md:text-2xl w-auto mx-2 text-center  z-20 cursor-pointer">
            Discover a sanctuary where artistry meets rejuvenation. We craft
            bespoke experiences designed to enhance your natural radiance and
            leave you feeling uniquely you.
          </p>
          <div className="flex md:flex-row flex-col gap-6 m-15 z-20">
            <Link
              href={"/services"}
              className="md:text-[19px] text-center font-extrabold px-5 py-4 cursor-pointer shadow-2xl shadow-amber-300/40 bg-gradient-to-r from-amber-500 to-amber-300 rounded-md text-black  hover:scale-105 transition-all duration-500"
            >
              Explore Services
            </Link>
            <Link
              href={"/contact"}
              className="md:text-[19px] text-center border-2 border-white shadow-2xl shadow-white/20 rounded-md font-extrabold px-5 py-4 cursor-pointer text-white  hover:scale-105 transition-all duration-500"
            >
              Book a Consultation
            </Link>
          </div>
